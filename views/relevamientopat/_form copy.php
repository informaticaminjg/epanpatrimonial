...
function agregarBienSimulado(
   ...
   console.log(sector);
    ...
    if (typeof bienesRegistradosSimulados === 'undefined') {
        window.bienesRegistradosSimulados = [];
    }

    bienesRegistradosSimulados.push(bien);
console.log("BIEN GUARDADO:");
console.log(bienesRegistradosSimulados);
console.log("SECTOR GUARDADO:", bien.sector);

    const index =
        bienesRegistradosSimulados.length - 1;
...
function agregarBienAlRelevamiento()
{
    ...
    if (existe) {
        ...
        mostrarToast('Esta matrícula ya fue agregada al relevamiento.', 'warning');
        return;
     ...
     *
     * NO agregamos id
     * NO agregamos idrelevamiento
     *
     * Los genera la base de datos / servidor.
     */
    ...
    * Ahora podemos limpiar las fotos temporales.
    */
    ...
    bienesRelevados.forEach(function (bien, index) {
        ...
        item.innerHTML = `
            ...
            <div class="bien-item-info">
                ...
                <strong>
                    Matrícula: ${escapeHtml(bien.matricula)}
                     <span class="bien-fotos"  title="Cantidad de fotos del bien relevado: ${(bien.fotos || []).length}">
                        <i class="fa-solid fa-camera"></i>
                        ${(bien.fotos || []).length}
                    </span>
                </strong>
                ...
                <span>
                    <b>Sector:</b>
                    ${escapeHtml(bien.sector || 'Sin especificar')}
                </span>s
                <span class="bien-estado">
                    Estado:
